...
This guide is intended for maintainers — anybody with commit access to one or more Developer Pattern repositories.
...
indicate acceptance. A change requires LGTMs from two of the members of the [cda-journey-dev-admins](https://github.com/orgs/IBM/teams/cda-journey-dev-admins) team. If the code is written by a member, the change only requires one more LGTM.
